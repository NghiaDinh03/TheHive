-- Initial tenant records — realistic TheHive 4-style operational data for the Investigation tabs.
...
VALUES
    ('NCS SOC', 'Default SOC tenant used for local TheHive 4 parity work'),
    ('Finance', 'Finance business unit used in sharing records'),
    ('IT Operations', 'IT operations business unit used in assignment records')
...
ON CONFLICT (id) DO UPDATE SET
    ...
    case_template = EXCLUDED.case_template,
    owning_organisation = EXCLUDED.owning_organisation,
...
DELETE FROM observables WHERE id IN (
...
DELETE FROM task_items WHERE case_id IN (
...
DELETE FROM case_logs WHERE case_id IN (
    '10000000-0000-0000-0000-000000000001',
    '10000000-0000-0000-0000-000000000002',
    '10000000-0000-0000-0000-000000000003'
);
...
ON CONFLICT (case_id, organisation) DO UPDATE SET
    profile = EXCLUDED.profile,
    task_rule = EXCLUDED.task_rule,
    observable_rule = EXCLUDED.observable_rule,
    owner = EXCLUDED.owner,
    task_action_required = EXCLUDED.task_action_required,
    updated_at = EXCLUDED.updated_at;
