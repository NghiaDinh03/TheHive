...
INSERT INTO organisations (id, name, description, created_at, updated_at) VALUES
  ('a0000000-0000-0000-0000-000000000001', 'CERT-Internal', 'Internal CERT team — primary SOC operator', '2026-01-15T08:00:00Z', '2026-01-15T08:00:00Z'),
  ('a0000000-0000-0000-0000-000000000002', 'MSSP-Partner', 'Managed security service provider — external partner', '2026-01-20T10:00:00Z', '2026-01-20T10:00:00Z'),
  ('a0000000-0000-0000-0000-000000000003', 'Finance-SOC', 'Finance division SOC — restricted access', '2026-02-01T09:00:00Z', '2026-02-01T09:00:00Z')
...
INSERT INTO users (id, login, name, organisation_id, profile_id, status, created_at, updated_at) VALUES
  ('c0000000-0000-0000-0000-000000000001', 'admin@thehive.local', 'Admin User',
    ...
    '2026-01-15T08:00:00Z', '2026-01-15T08:00:00Z'),
  ('c0000000-0000-0000-0000-000000000002', 'alice.cert@thehive.local', 'Alice Nguyen',
    'a0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000002', 'Ok',
    '2026-01-16T09:00:00Z', '2026-01-16T09:00:00Z'),
  ('c0000000-0000-0000-0000-000000000003', 'bob.cert@thehive.local', 'Bob Tran',
    'a0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000002', 'Ok',
    '2026-01-16T09:30:00Z', '2026-01-16T09:30:00Z'),
  ('c0000000-0000-0000-0000-000000000004', 'carol.mssp@thehive.local', 'Carol Le',
    'a0000000-0000-0000-0000-000000000002', 'b0000000-0000-0000-0000-000000000002', 'Ok',
    '2026-02-01T10:00:00Z', '2026-02-01T10:00:00Z'),
  ('c0000000-0000-0000-0000-000000000005', 'dave.finance@thehive.local', 'Dave Pham',
...
INSERT INTO cases (id, legacy_id, number, title, description, severity, tlp, pap, status, owner, assignee, tags, flag, summary, impact_status, resolution_status, case_template, owning_organisation, organisation_ids, start_date, end_date, created_at, updated_at) VALUES
  ...
  ('d0000000-0000-0000-0000-000000000001', 'legacy-case-001', 1,
   'Ransomware Incident — Finance Dept Workstation',
   ...
   3, 3, 3, 'Open', 'alice.cert@thehive.local', 'alice.cert@thehive.local',
   ARRAY['ransomware','lockbit','phishing','finance','critical'],
   true, '', 'WithImpact', '', '', 'CERT-Internal',
   ARRAY['CERT-Internal'],
  ...
  ('d0000000-0000-0000-0000-000000000002', 'legacy-case-002', 2,
   ...
   2, 2, 2, 'Resolved', 'bob.cert@thehive.local', 'bob.cert@thehive.local',
   ...
   'NoImpact', 'Duplicated', '', 'CERT-Internal',
   ARRAY['CERT-Internal'],
  ...
  ('d0000000-0000-0000-0000-000000000003', 'legacy-case-003', 3,
   ...
   'Wave of phishing emails targeting HR department with fake SharePoint login pages. 3 employees reported clicking link. Credential harvesting kit hosted on compromised WordPress site. IoCs shared with MSSP partner.',
   2, 2, 2, 'Open', 'alice.cert@thehive.local', 'bob.cert@thehive.local',
   ARRAY['phishing','credential-theft','sharepoint','hr-department'],
   true, '', 'NoImpact', '', '', 'CERT-Internal',
   ARRAY['CERT-Internal','MSSP-Partner'],
  ...
  ('d0000000-0000-0000-0000-000000000004', 'legacy-case-004', 4,
   ...
   3, 4, 3, 'Open', 'alice.cert@thehive.local', 'alice.cert@thehive.local',
   ARRAY['insider-threat','data-exfiltration','dlp','usb','rd-department'],
   true, '', 'WithImpact', '', '', 'CERT-Internal',
   ARRAY['CERT-Internal','Finance-SOC'],
  ...
  ('d0000000-0000-0000-0000-000000000005', 'legacy-case-005', 5,
   ...
   'NoImpact', 'Indeterminate', '', 'CERT-Internal',
   ARRAY['CERT-Internal'],
  ...
  ('d0000000-0000-0000-0000-000000000006', 'legacy-case-006', 6,
   'Log4Shell Exploitation — Internet-Facing Server',
   ...
   4, 3, 4, 'Open', 'alice.cert@thehive.local', 'alice.cert@thehive.local',
  ...
  ('d0000000-0000-0000-0000-000000000007', 'legacy-case-007', 7,
   'Suspicious PowerShell Execution — SOC Lab',
   ...
   1, 1, 1, 'Open', 'bob.cert@thehive.local', 'bob.cert@thehive.local',
   ARRAY['powershell','edr','suspicious','lab-environment'],
   false, '', 'NoImpact', '', '', 'CERT-Internal',
   ARRAY['CERT-Internal'],
   '2026-05-04T11:00:00Z', NULL,
   '2026-05-04T11:00:00Z', '2026-05-04T11:00:00Z'),

  -- Case 8: MSSP escalated — Open, medium
  ('d0000000-0000-0000-0000-000000000008', 'legacy-case-008', 8,
   'Brute Force Attack — VPN Gateway',
   'MSSP detected sustained brute force attack against VPN gateway. 15,000+ failed login attempts from Eastern European IP ranges. Account lockout policy triggered. No successful compromise detected.',
   2, 2, 2, 'Open', 'carol.mssp@thehive.local', 'carol.mssp@thehive.local',
   ARRAY['brute-force','vpn','mssp','lockout','eastern-europe'],
   false, '', 'NoImpact', '', '', 'MSSP-Partner',
   ARRAY['MSSP-Partner','CERT-Internal'],
  ...
  ('d0000000-0000-0000-0000-000000000009', 'legacy-case-009', 9,
   'BEC Attempt — CFO Wire Transfer Request',
   'Duplicate of case #2. Same BEC campaign targeting CFO with wire transfer request.',
   2, 2, 2, 'Duplicated', 'bob.cert@thehive.local', 'bob.cert@thehive.local',
   ARRAY['bec','duplicate'],
   false, 'Duplicate of case #2.', 'NoImpact', '', '',
   'CERT-Internal', ARRAY['CERT-Internal'],
...
INSERT INTO case_shares (id, case_id, organisation, profile, owner, task_action_required, created_at, updated_at) VALUES
  ('e0000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000001', 'CERT-Internal', 'analyst', true, false, '2026-04-28T14:30:00Z', '2026-04-28T14:30:00Z'),
  ('e0000000-0000-0000-0000-000000000002', 'd0000000-0000-0000-0000-000000000001', 'MSSP-Partner', 'analyst', false, true, '2026-04-29T08:00:00Z', '2026-04-29T08:00:00Z'),
  ('e0000000-0000-0000-0000-000000000003', 'd0000000-0000-0000-0000-000000000003', 'CERT-Internal', 'analyst', true, false, '2026-05-01T08:00:00Z', '2026-05-01T08:00:00Z'),
  ('e0000000-0000-0000-0000-000000000004', 'd0000000-0000-0000-0000-000000000003', 'MSSP-Partner', 'analyst', false, false, '2026-05-01T09:00:00Z', '2026-05-01T09:00:00Z'),
  ('e0000000-0000-0000-0000-000000000005', 'd0000000-0000-0000-0000-000000000004', 'CERT-Internal', 'analyst', true, false, '2026-05-02T16:00:00Z', '2026-05-02T16:00:00Z'),
  ('e0000000-0000-0000-0000-000000000006', 'd0000000-0000-0000-0000-000000000004', 'Finance-SOC', 'read-only', false, false, '2026-05-03T09:00:00Z', '2026-05-03T09:00:00Z'),
  ('e0000000-0000-0000-0000-000000000007', 'd0000000-0000-0000-0000-000000000008', 'MSSP-Partner', 'analyst', true, false, '2026-05-04T15:30:00Z', '2026-05-04T15:30:00Z'),
  ('e0000000-0000-0000-0000-000000000008', 'd0000000-0000-0000-0000-000000000008', 'CERT-Internal', 'analyst', false, true, '2026-05-04T16:00:00Z', '2026-05-04T16:00:00Z')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO task_items (id, case_id, title, status, assignee, group_name, order_index, flag, description, start_date, end_date, due_date, organisation_ids, created_at, updated_at) VALUES
  ...
  ('f0000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000001',
   'Isolate affected workstations from network', 'Completed', 'alice.cert@thehive.local',
   ...
   ARRAY['CERT-Internal'], '2026-04-28T14:30:00Z', '2026-04-28T16:30:00Z'),

  ('f0000000-0000-0000-0000-000000000002', 'd0000000-0000-0000-0000-000000000001',
   'Collect forensic images from affected systems', 'InProgress', 'bob.cert@thehive.local',
   ...
   ARRAY['CERT-Internal'], '2026-04-28T14:30:00Z', '2026-04-29T09:00:00Z'),

  ('f0000000-0000-0000-0000-000000000003', 'd0000000-0000-0000-0000-000000000001',
   'Analyze phishing email headers and payload', 'Completed', 'alice.cert@thehive.local',
   ...
   ARRAY['CERT-Internal'], '2026-04-28T14:30:00Z', '2026-04-29T11:00:00Z'),

  ('f0000000-0000-0000-0000-000000000004', 'd0000000-0000-0000-0000-000000000001',
   'Check backup integrity and prepare restoration plan', 'Waiting', 'alice.cert@thehive.local',
   ...
   ARRAY['CERT-Internal'], '2026-04-28T14:30:00Z', '2026-04-28T14:30:00Z'),

  ('f0000000-0000-0000-0000-000000000005', 'd0000000-0000-0000-0000-000000000001',
   'Notify affected stakeholders and prepare incident report', 'Waiting', 'alice.cert@thehive.local',
  ...
  ('f0000000-0000-0000-0000-000000000006', 'd0000000-0000-0000-0000-000000000003',
   'Reset credentials for 3 affected employees', 'InProgress', 'bob.cert@thehive.local',
   ...
   ARRAY['CERT-Internal'], '2026-05-01T08:00:00Z', '2026-05-01T10:00:00Z'),

  ('f0000000-0000-0000-0000-000000000007', 'd0000000-0000-0000-0000-000000000003',
   'Block phishing domains at DNS/proxy level', 'Completed', 'bob.cert@thehive.local',
   ...
   ARRAY['CERT-Internal'], '2026-05-01T08:00:00Z', '2026-05-01T09:30:00Z'),

  ('f0000000-0000-0000-0000-000000000008', 'd0000000-0000-0000-0000-000000000003',
   'Analyze phishing kit on compromised WordPress site', 'Waiting', 'alice.cert@thehive.local',
   ...
   ARRAY['CERT-Internal'], '2026-05-01T08:00:00Z', '2026-05-01T08:00:00Z'),

  -- Case 4 tasks: Insider threat
  ('f0000000-0000-0000-0000-000000000009', 'd0000000-0000-0000-0000-000000000004',
   'Review DLP logs for data exfiltration scope', 'InProgress', 'alice.cert@thehive.local',
   ...
   ARRAY['CERT-Internal'], '2026-05-02T16:00:00Z', '2026-05-02T16:30:00Z'),

  ('f0000000-0000-0000-0000-000000000010', 'd0000000-0000-0000-0000-000000000004',
   'Coordinate with HR and Legal for employee interview', 'Waiting', 'alice.cert@thehive.local',
   'HR/Legal', 0, false, 'Schedule meeting with HR and Legal to discuss employee interview strategy. Prepare evidence summary.',
   NULL, NULL, '2026-05-06T18:00:00Z',
   ARRAY['CERT-Internal'], '2026-05-02T16:00:00Z', '2026-05-02T16:00:00Z'),

  -- Case 6 tasks: Log4Shell
  ('f0000000-0000-0000-0000-000000000011', 'd0000000-0000-0000-0000-000000000006',
   'Verify APP-PROD-03 is patched against Log4Shell', 'Completed', 'alice.cert@thehive.local',
   ...
   ARRAY['CERT-Internal'], '2026-05-03T03:15:00Z', '2026-05-03T05:30:00Z'),

  ('f0000000-0000-0000-0000-000000000012', 'd0000000-0000-0000-0000-000000000006',
   'Analyze forensic image for post-exploitation artifacts', 'InProgress', 'bob.cert@thehive.local',
   ...
   ARRAY['CERT-Internal'], '2026-05-03T03:15:00Z', '2026-05-03T08:00:00Z'),

  -- Case 8 tasks: Brute force
  ('f0000000-0000-0000-0000-000000000013', 'd0000000-0000-0000-0000-000000000008',
   'Block attacking IP ranges at firewall', 'Completed', 'carol.mssp@thehive.local',
   ...
   ARRAY['MSSP-Partner'], '2026-05-04T15:30:00Z', '2026-05-04T17:00:00Z'),

  ('f0000000-0000-0000-0000-000000000014', 'd0000000-0000-0000-0000-000000000008',
   'Review VPN logs for any successful compromises', 'Waiting', 'carol.mssp@thehive.local',
   ...
   NULL, NULL, '2026-05-06T18:00:00Z',
   ARRAY['MSSP-Partner'], '2026-05-04T15:30:00Z', '2026-05-04T15:30:00Z')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO alerts (id, legacy_id, title, type, source, source_ref, severity, tlp, pap, status, read, follow, flag, description, external_link, last_sync_date, organisation_id, case_id, case_template, tags, occurred_at, created_at, updated_at) VALUES
  ...
  ('10000000-0000-0000-0000-000000000001', 'legacy-alert-001',
   ...
   '2026-04-28T14:25:00Z', 'CERT-Internal',
  ...
  ('10000000-0000-0000-0000-000000000002', 'legacy-alert-002',
   ...
   '',
   '2026-04-15T09:55:00Z', 'CERT-Internal',
  ...
  ('10000000-0000-0000-0000-000000000003', 'legacy-alert-003',
   ...
   '',
   '2026-05-01T07:55:00Z', 'CERT-Internal',
   NULL, '',
  ...
  ('10000000-0000-0000-0000-000000000004', 'legacy-alert-004',
   ...
   '',
   '2026-05-02T15:55:00Z', 'CERT-Internal',
  ...
  ('10000000-0000-0000-0000-000000000005', 'legacy-alert-005',
   ...
   '',
   '2026-05-03T03:10:00Z', 'CERT-Internal',
  ...
  ('10000000-0000-0000-0000-000000000006', 'legacy-alert-006',
   ...
   '',
   '2026-05-04T10:55:00Z', 'CERT-Internal',
   NULL, '',
  ...
  ('10000000-0000-0000-0000-000000000007', 'legacy-alert-007',
   ...
   '',
   '2026-05-04T15:25:00Z', 'MSSP-Partner',
  ...
  ('10000000-0000-0000-0000-000000000008', 'legacy-alert-008',
   ...
   '',
   '2026-05-05T08:30:00Z', 'CERT-Internal',
   NULL, '',
  ...
  ('10000000-0000-0000-0000-000000000009', 'legacy-alert-009',
   ...
   '',
   '2026-05-05T09:15:00Z', 'CERT-Internal',
   NULL, '',
  ...
  ('10000000-0000-0000-0000-000000000010', 'legacy-alert-010',
   ...
   '2026-05-05T10:00:00Z', 'CERT-Internal',
   NULL, '',
...
INSERT INTO observables (id, legacy_id, case_id, data_type, data, message, tlp, ioc, sighted, ignore_similarity, tags, created_by, created_at, updated_at) VALUES
  ...
  ('20000000-0000-0000-0000-000000000001', 'legacy-obs-001',
   ...
   3, true, true, false, ARRAY['c2','lockbit','ransomware'], 'alice.cert@thehive.local',
  ...
  ('20000000-0000-0000-0000-000000000002', 'legacy-obs-002',
   ...
   3, true, true, false, ARRAY['lockbit','onion','leak-site'], 'alice.cert@thehive.local',
  ...
  ('20000000-0000-0000-0000-000000000003', 'legacy-obs-003',
   ...
   3, true, true, false, ARRAY['ransomware','lockbit','payload'], 'alice.cert@thehive.local',
  ...
  ('20000000-0000-0000-0000-000000000004', 'legacy-obs-004',
   ...
   2, true, true, false, ARRAY['phishing','email','spoofed'], 'alice.cert@thehive.local',
  ...
  ('20000000-0000-0000-0000-000000000005', 'legacy-obs-005',
   ...
   2, true, true, false, ARRAY['phishing','credential-theft','url'], 'bob.cert@thehive.local',
  ...
  ('20000000-0000-0000-0000-000000000006', 'legacy-obs-006',
   ...
   2, true, true, false, ARRAY['phishing','domain','compromised'], 'bob.cert@thehive.local',
  ...
  ('20000000-0000-0000-0000-000000000007', 'legacy-obs-007',
   ...
   2, true, true, false, ARRAY['phishing','ip','hosting'], 'bob.cert@thehive.local',
  ...
  ('20000000-0000-0000-0000-000000000008', 'legacy-obs-008',
   ...
   4, true, false, false, ARRAY['insider-threat','usb','hardware'], 'alice.cert@thehive.local',
  ...
  ('20000000-0000-0000-0000-000000000009', 'legacy-obs-009',
   ...
   4, true, true, false, ARRAY['insider-threat','user','employee'], 'alice.cert@thehive.local',
  ...
  ('20000000-0000-0000-0000-000000000010', 'legacy-obs-010',
   ...
   3, true, true, false, ARRAY['log4shell','exploitation','ip'], 'alice.cert@thehive.local',
  ...
  ('20000000-0000-0000-0000-000000000011', 'legacy-obs-011',
   ...
   3, true, true, false, ARRAY['log4shell','payload','jndi'], 'alice.cert@thehive.local',
  ...
  ('20000000-0000-0000-0000-000000000012', 'legacy-obs-012',
   ...
   3, false, false, false, ARRAY['forensics','hash','evidence'], 'bob.cert@thehive.local',
...
INSERT INTO case_logs (id, case_id, task_id, message, created_by, created_at) VALUES
  ...
  ('30000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000001', NULL,
   ...
   'alice.cert@thehive.local', '2026-04-28T14:35:00Z'),
  ...
  ('30000000-0000-0000-0000-000000000002', 'd0000000-0000-0000-0000-000000000001', 'f0000000-0000-0000-0000-000000000001',
   ...
   'alice.cert@thehive.local', '2026-04-28T16:35:00Z'),
  ...
  ('30000000-0000-0000-0000-000000000003', 'd0000000-0000-0000-0000-000000000001', 'f0000000-0000-0000-0000-000000000003',
   ...
   'alice.cert@thehive.local', '2026-04-29T11:05:00Z'),

  ('30000000-0000-0000-0000-000000000004', 'd0000000-0000-0000-0000-000000000001', NULL,
   'MSSP partner notified. They will monitor for lateral movement indicators in their SIEM. Shared IOCs via MISP event #4521.',
   'alice.cert@thehive.local', '2026-04-29T14:00:00Z'),
  ...
  ('30000000-0000-0000-0000-000000000005', 'd0000000-0000-0000-0000-000000000003', NULL,
   ...
   'bob.cert@thehive.local', '2026-05-01T09:00:00Z'),
  ...
  ('30000000-0000-0000-0000-000000000006', 'd0000000-0000-0000-0000-000000000003', 'f0000000-0000-0000-0000-000000000007',
   ...
   'bob.cert@thehive.local', '2026-05-01T09:35:00Z'),
  ...
  ('30000000-0000-0000-0000-000000000007', 'd0000000-0000-0000-0000-000000000004', NULL,
   ...
   'alice.cert@thehive.local', '2026-05-02T16:45:00Z'),
  ...
  ('30000000-0000-0000-0000-000000000008', 'd0000000-0000-0000-0000-000000000006', NULL,
   ...
   'alice.cert@thehive.local', '2026-05-03T03:30:00Z'),
  ...
  ('30000000-0000-0000-0000-000000000009', 'd0000000-0000-0000-0000-000000000006', 'f0000000-0000-0000-0000-000000000011',
   ...
   'alice.cert@thehive.local', '2026-05-03T05:35:00Z')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO audit_logs (id, request_id, action, object_type, object_id, base, user_name, user_organisation, created_at) VALUES
  ('60000000-0000-0000-0000-000000000001', 'req-001', 'create', 'case', 'd0000000-0000-0000-0000-000000000001', '/api/v1/cases', 'alice.cert@thehive.local', 'CERT-Internal', '2026-04-28T14:30:00Z'),
  ('60000000-0000-0000-0000-000000000002', 'req-002', 'update', 'case', 'd0000000-0000-0000-0000-000000000001', '/api/v1/cases/d0000000-0000-0000-0000-000000000001', 'alice.cert@thehive.local', 'CERT-Internal', '2026-04-28T15:00:00Z'),
  ('60000000-0000-0000-0000-000000000003', 'req-003', 'create', 'task', 'f0000000-0000-0000-0000-000000000001', '/api/v1/cases/d0000000-0000-0000-0000-000000000001/tasks', 'alice.cert@thehive.local', 'CERT-Internal', '2026-04-28T14:30:00Z'),
  ('60000000-0000-0000-0000-000000000004', 'req-004', 'update', 'task', 'f0000000-0000-0000-0000-000000000001', '/api/v1/tasks/f0000000-0000-0000-0000-000000000001', 'alice.cert@thehive.local', 'CERT-Internal', '2026-04-28T16:30:00Z'),
  ('60000000-0000-0000-0000-000000000005', 'req-005', 'create', 'observable', '20000000-0000-0000-0000-000000000001', '/api/v1/cases/d0000000-0000-0000-0000-000000000001/observables', 'alice.cert@thehive.local', 'CERT-Internal', '2026-04-28T15:00:00Z'),
  ('60000000-0000-0000-0000-000000000006', 'req-006', 'import', 'alert', '10000000-0000-0000-0000-000000000001', '/api/v1/alerts/import', 'system', 'CERT-Internal', '2026-04-28T14:25:00Z'),
  ('60000000-0000-0000-0000-000000000007', 'req-007', 'merge', 'alert', '10000000-0000-0000-0000-000000000001', '/api/v1/alerts/10000000-0000-0000-0000-000000000001/merge', 'alice.cert@thehive.local', 'CERT-Internal', '2026-04-28T14:30:00Z'),
  ('60000000-0000-0000-0000-000000000008', 'req-008', 'create', 'case', 'd0000000-0000-0000-0000-000000000003', '/api/v1/cases', 'alice.cert@thehive.local', 'CERT-Internal', '2026-05-01T08:00:00Z'),
  ('60000000-0000-0000-0000-000000000009', 'req-009', 'create', 'case', 'd0000000-0000-0000-0000-000000000004', '/api/v1/cases', 'alice.cert@thehive.local', 'CERT-Internal', '2026-05-02T16:00:00Z'),
  ('60000000-0000-0000-0000-000000000010', 'req-010', 'create', 'case', 'd0000000-0000-0000-0000-000000000006', '/api/v1/cases', 'alice.cert@thehive.local', 'CERT-Internal', '2026-05-03T03:15:00Z'),
  ('60000000-0000-0000-0000-000000000011', 'req-011', 'create', 'case', 'd0000000-0000-0000-0000-000000000008', '/api/v1/cases', 'carol.mssp@thehive.local', 'MSSP-Partner', '2026-05-04T15:30:00Z'),
  ('60000000-0000-0000-0000-000000000012', 'req-012', 'update', 'case', 'd0000000-0000-0000-0000-000000000002', '/api/v1/cases/d0000000-0000-0000-0000-000000000002', 'bob.cert@thehive.local', 'CERT-Internal', '2026-04-16T16:45:00Z'),
  ('60000000-0000-0000-0000-000000000013', 'req-013', 'merge', 'case', 'd0000000-0000-0000-0000-000000000009', '/api/v1/cases/d0000000-0000-0000-0000-000000000009/merge', 'bob.cert@thehive.local', 'CERT-Internal', '2026-04-16T09:30:00Z')
ON CONFLICT (id) DO NOTHING;
...
--   - 3 organisations (CERT-Internal, MSSP-Partner, Finance-SOC)
--   - 3 profiles (superadmin, analyst, read-only)
--   - 5 users (admin, alice, bob, carol, dave)
--   - 9 cases (ransomware, BEC, phishing, insider threat, DDoS, Log4Shell, PowerShell, brute force, duplicate)
--   - 8 case shares (multi-org sharing)
--   - 14 tasks across 6 cases (various statuses)
--   - 10 alerts (various types, statuses, sources)
--   - 15 observables (IPs, domains, hashes, URLs, emails)
--   - 9 case logs (markdown investigation notes)
--   - 7 custom fields (case and alert level)
--   - 20 tags
