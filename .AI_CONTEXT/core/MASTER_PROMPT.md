...
1. `.AI_CONTEXT/MEMORY.md` — Lessons learned, decisions log
2. `.AI_CONTEXT/plan.md` — Work plan hiện tại
3. `.AI_CONTEXT/STRUCTURE.md` — Bản đồ project
...
- Ứng dụng luôn sử dụng Tiếng Anh (English) làm ngôn ngữ mặc định trên UI. Chưa thực hiện Việt hóa.
- `.AI_CONTEXT/MEMORY.md` — **APPEND ONLY**, không bao giờ xóa
- `.AI_CONTEXT/STRUCTURE.md` — Cập nhật ngay khi structure thay đổi
...
Xem `.AI_CONTEXT/plan.md` để biết task đang làm.
